<?php
    ...
    abstract class Analitik {
        abstract public function banyakGanjil($arr);
        abstract public function banyakGenap($arr);
...
class AnakAnalisa extends IndukPerhitungan {
    ...
    public function initialArray(){
        ...
        echo "<br>Banyaknya Nilai Ganjil " .$this->banyakGanjil($arr);
        echo "<br>Banyaknya Nilai Genap " .$this->banyakGenap($arr);
        echo "<br>-------------------<br>";
        print_r($arr);
    }  
